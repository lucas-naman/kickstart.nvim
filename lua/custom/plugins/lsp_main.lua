return {
  {
    ...
    dependencies = {
      ...
      'saghen/blink.cmp',
      -- This is the core completion plugin
      'hrsh7th/nvim-cmp',
      ...
      'hrsh7th/cmp-path',
      -- Snippet support (optional, but highly recommended for better completion)
      'L3MON4D3/LuaSnip',
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- This section is for LSP client keymaps (your existing ones)
      ...
      local servers = {
        ...
        gopls = {
          ...
          settings = {
            gopls = {
              -- Crucial for auto-imports and formatting
              goimports = true, -- Use goimports to organize imports
              gofumpt = true, -- Use gofumpt for stricter formatting
              completeUnimported = true, -- Auto-import during completion
              deepCompletion = true, -- Deeper completion for types
              usePlaceholders = true, -- Use placeholders for function arguments
              analyses = {
                unusedparams = true,
                unusedwrite = true,
                nilness = true,
                -- Add more analyses here as desired
              },
